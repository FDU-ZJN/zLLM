...
def run_accuracy_eval(tokenizer, model, eval_data: list, max_new_tokens) -> dict:
    """
    逐题推理并统计准确率。
    """
...
if __name__ == "__main__":
    ...
    result = run_accuracy_eval(tokenizer, model, eval_data, max_new_tokens=args.max_new_tokens)
